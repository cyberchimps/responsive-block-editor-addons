...
class DividerCest {
	...
	public function dividerBlockTest( RBEATester $I, LogInAndLogOut $loginAndLogout, CommonFunctionsPage $commonFunctionsPageObj ) {
		...
		$marginElement = $I->executeInSelenium(
			function ( RemoteWebDriver $webdriver ) {
		...
		$heightElement = $I->executeInSelenium(
			function ( RemoteWebDriver $webdriver ) {
		...
		$widthElement = $I->executeInSelenium(
			function ( RemoteWebDriver $webdriver ) {
		...
		$dividerStyle = $I->executeInSelenium(
			function ( RemoteWebDriver $webdriver ) {
