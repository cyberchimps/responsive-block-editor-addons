          ...
          <InspectorTab key={'style'}>
            ...
            >
              <p className="responsive-block-editor-addons-setting-label">
                {__("Heading Title Color", "responsive-block-editor-addons")}
              ...
              />
              <p className="responsive-block-editor-addons-setting-label">
                {__("Sub Heading Title Color", "responsive-block-editor-addons")}
                <span className="components-base-control__label">
                  <span
                    className="component-color-indicator"
            ...
            >
              <ResponsiveSpacingControl
                ...
                values={{ desktop: headSpacing, tablet: headSpacingTablet, mobile: headSpacingMobile }}
                setAttributes={setAttributes}
                {...this.props}
              />
              {seperatorStyle !== "none" && (
                <ResponsiveSpacingControl
                  ...
                  values={{ desktop: separatorSpacing, tablet: separatorSpacingTablet, mobile: separatorSpacingMobile }}
                  setAttributes={setAttributes}
                  {...this.props}
                />
              )}
              {showSubHeading && (
                <ResponsiveSpacingControl
                  ...
                  values={{ desktop: subheadSpacing, tablet: subheadSpacingTablet, mobile: subheadSpacingMobile }}
                  setAttributes={setAttributes}
                  {...this.props}
                />
              )}
