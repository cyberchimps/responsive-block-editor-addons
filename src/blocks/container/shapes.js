...
const shapes = {
	triangle: el(
		...
		el( 'path', {
			className: 'responsive-block-editor-addons-container__shape-fill',
	...
	mountains: el(
		...
		el( 'path', {
			...
			opacity: '0.33',
			d:
				'M473,67.3c-203.9,88.3-263.1-34-320.3,0C66,119.1,0,59.7,0,59.7V0h1000v59.7 c0,0-62.1,26.1-94.9,29.3c-32.8,3.3-62.8-12.3-75.8-22.1C806,49.6,745.3,8.7,694.9,4.7S492.4,59,473,67.3z',
		} ),
		el( 'path', {
			className: 'responsive-block-editor-addons-container__shape-fill',
			opacity: '0.66',
			d:
				'M734,67.3c-45.5,0-77.2-23.2-129.1-39.1c-28.6-8.7-150.3-10.1-254,39.1 s-91.7-34.4-149.2,0C115.7,118.3,0,39.8,0,39.8V0h1000v36.5c0,0-28.2-18.5-92.1-18.5C810.2,18.1,775.7,67.3,734,67.3z',
		} ),
		el( 'path', {
			className: 'responsive-block-editor-addons-container__shape-fill',
			d:
				'M766.1,28.9c-200-57.5-266,65.5-395.1,19.5C242,1.8,242,5.4,184.8,20.6C128,35.8,132.3,44.9,89.9,52.5C28.6,63.7,0,0,0,0 h1000c0,0-9.9,40.9-83.6,48.1S829.6,47,766.1,28.9z',
		} )
	),
	waves: el(
		'svg',
	...
	arrow_split: el(
		...
		el( 'path', {
			className: 'responsive-block-editor-addons-container__shape-fill',
			d:
				'M0,0v3c0,0,393.8,0,483.4,0c9.2,0,16.6,7.4,16.6,16.6c0-9.1,7.4-16.6,16.6-16.6C606.2,3,1000,3,1000,3V0H0z',
		} )
	),
	book: el(
		'svg',
		...
		el( 'path', {
			className: 'responsive-block-editor-addons-container__shape-fill',
			d:
				'M194,99c186.7,0.7,305-78.3,306-97.2c1,18.9,119.3,97.9,306,97.2c114.3-0.3,194,0.3,194,0.3s0-91.7,0-100c0,0,0,0,0-0 L0,0v99.3C0,99.3,79.7,98.7,194,99z',
		} )
	),
	curve_reverse: el(
		'svg',
