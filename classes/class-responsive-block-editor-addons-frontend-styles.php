...
return array(
    ...
    'hoverbackgroundColor2' => '#fff',
        ...
        public static function get_responsive_block_call_to_action_css( $attr, $id ) {
            ...
            }else if ($attr['iconPosition'] === 'after') {
            ...
            $gutterMarginIb = "";
                if( $attr['count'] > 1){
                    if($attr['gutter'] === "small"){
                        $gutterMarginIb = '20px';
                    }else if ($attr['gutter'] === "medium"){
                        $gutterMarginIb = '30px';
                    }else if ($attr['gutter'] === "large"){
                        $gutterMarginIb = '40px';
                    }else if ($attr['gutter'] === "huge"){
                        $gutterMarginIb = '50px';
                    }else {
                        $gutterMarginIb = '';
                }
		...
		public static function get_responsive_block_table_of_contents_css ( $attr, $id) {
			...
			$selectors = array(
				' ' => array(
					...
					'background-repeat'   => $attr['backgroundRepeat'],
					'background-size'     => $attr['backgroundSize'],
					'background-color'    => $attr['backgroundType'] === 'color' ? self::hexToRgb(
						$attr['backgroundColor'],
						1
					) : null,
				),
