...
class InfoBlockCest {
	...
	public function InfoBlockCallToActionTest( RBEATester $I, CommonFunctionsPage $commonFunctionsPageObj ) {
		...
		$I->wait( 1 );
		$openInNewTabBtn = $I->executeInSelenium(
			function ( RemoteWebDriver $webdriver ) {
		...
		$I->click( $commonFunctionsPageObj->desktopView );
		$I->wait( 4 );
		$topPadding = $I->executeInSelenium(
			function ( RemoteWebDriver $webdriver ) {
	...
	public function InfoBlockSpacingStyleTest( RBEATester $I, CommonFunctionsPage $commonFunctionsPageObj ) {
		...
		$commonFunctionsPageObj->_setInputFieldKeys( $I, 'xpath', '10' );
		$imageOrIconMarginBtn = $I->executeInSelenium(
			function ( RemoteWebDriver $webdriver ) {
		...
		$I->wait( 1 );
		$rightMargin = $I->executeInSelenium(
			function ( RemoteWebDriver $webdriver ) {
	...
	public function _setBoxShadowAttributes( $I, $commonFunctionsPageObj ) {
		...
		$commonFunctionsPageObj->_setInputFieldKeys( $I, 'xpath', '5' );
		$separatorStyleBtn = $I->executeInSelenium(
			function ( RemoteWebDriver $webdriver ) {
	...
	public function InfoBlockSeparatorStyleTest( RBEATester $I, CommonFunctionsPage $commonFunctionsPageObj ) {
		...
		$separatorPosition = $I->executeInSelenium(
			function ( RemoteWebDriver $webdriver ) {
	...
	public function InfoBlockContentStyleTest( RBEATester $I, CommonFunctionsPage $commonFunctionsPageObj ) {
		...
		$I->wait( 1 );
		$enablePrefixBtn = $I->executeInSelenium(
			function ( RemoteWebDriver $webdriver ) {
