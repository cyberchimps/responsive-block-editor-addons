          ...
          <InspectorTab key={'style'}>
            ...
            >
              <ResponsiveSpacingControl
                ...
                values={{ desktop: horizontalSpace, tablet: horizontalSpaceTablet, mobile: horizontalSpaceMobile }}
                setAttributes={setAttributes}
                {...this.props}
              />
              <ResponsiveSpacingControl
                ...
                values={{ desktop: verticalSpace, tablet: verticalSpaceTablet, mobile: verticalSpaceMobile }}
                setAttributes={setAttributes}
                {...this.props}
              />
              <ResponsiveSpacingControl
                ...
                values={{ desktop: headingBottomMargin, tablet: headingBottomMarginTablet, mobile: headingBottomMarginMobile }}
                setAttributes={setAttributes}
                {...this.props}
              />
            </PanelBody>
