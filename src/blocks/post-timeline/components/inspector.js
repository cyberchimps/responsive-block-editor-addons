      ...
      <InspectorControls>
        <InspectorTabs>
          <InspectorTab key={"content"}>
            {queryControls}
            <PanelBody
              title={__("Post Timeline Settings", "responsive-block-editor-addons")}
              className={
            ...
            <PanelBody
              title={__("Post Timeline Content", "responsive-block-editor-addons")}
              initialOpen={false}
            >
              <ToggleControl
                label={__(
            ...
            <PanelBody
              title={__("Post Timeline Markup", "responsive-block-editor-addons")}
              initialOpen={false}
          ...
          <InspectorTab key={"style"}>
            ...
            >
              ...
              <Fragment>
                <PanelBody
                  title={__("CTA Color Settings", "responsive-block-editor-addons")}
                  initialOpen={false}
                >
                  <TabPanel
