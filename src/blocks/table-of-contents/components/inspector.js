			...
			<InspectorControls key="inspector">
				<InspectorTabs>
					...
					<InspectorTab key={"style"}>
						...
						>
											...
											tabout = (
												<Fragment>
													<p className="responsive-setting-label">
														{__("Hover Color", "responsive-block-editor-addons")}
							...
							>
								<SelectControl
									...
									onChange={(value) => setAttributes({ headingBorderStyle: value })}
									options={[
										{ value: "none", label: __("None") },
						...
						>
							<ToggleControl
								label={__("Collapsible Content", "responsive-block-editor-addons")}
						...
						>
							...
							>
								<SelectControl
									...
									onChange={(value) => setAttributes({ bodyBorderStyle: value })}
									options={[
										{ value: "none", label: __("None") },
										{ value: "solid", label: __("Solid") },
										{ value: "dotted", label: __("Dotted") },
