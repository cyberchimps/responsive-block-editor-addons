                ...
                <div className="flex justify-between">
                    <div className="flex items-center w-8/12 gap-6">
                        ...
                        <div className="flex w-full">
                            ...
                            {rbealocalize?.plan_details !== 'free' && (
    <div onClick={() => history.push('/ai-suite')} className={`hover:bg-sky-100 ${location.pathname === '/ai-suite' ? 'rbea-active-tab' : ''} cursor-pointer`}>
        <p className="text-slate-800 text-base font-medium my-6 px-5">{__('AI Suite', 'responsive-block-editor-addons')}</p>
    </div>
)}
