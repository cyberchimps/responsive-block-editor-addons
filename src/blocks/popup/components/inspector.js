                ...
                {popupTrigger === 'click' && <>
                  ...
                  {popupTriggerType === 'button' && <>
                    ...
                    <div className="responsive-block-editor-addons-popup-div-flex">
                      ...
                      <Button style={popupButtonPreset === '' ? {cursor: 'auto'} : {cursor: 'pointer'}} onClick={() => setAttributes({ popupButtonPreset: '', popupButtonBGColor: '#10659C', popupButtonColor: '#fff', popupButtonBorderRadius: 0, popupButtonTopRadius: 0, popupButtonRightRadius: 0, popupButtonBottomRadius: 0, popupButtonLeftRadius: 0, popupButtonTopRadiusTablet: 0, popupButtonRightRadiusTablet: 0, popupButtonBottomRadiusTablet: 0, popupButtonLeftRadiusTablet: 0, popupButtonTopRadiusMobile: 0, popupButtonRightRadiusMobile: 0, popupButtonBottomRadiusMobile: 0, popupButtonLeftRadiusMobile: 0, popupButtonIsRadiusValueUpdated: true })} size="small"><Dashicon icon="image-rotate" className={popupButtonPreset === '' ? 'image-rotate-reset' : ''} /></Button>
                    </div>
                    <div className="responsive-block-editor-addons-popup-button-preset-wrap">
                      <div className="responsive-block-editor-addons-popup-button-preset">
                        <button className={popupButtonPreset === 'preset1' ? 'selectedPresetBorder' : 'disabledPresetBorder'} onClick={() => setAttributes({ popupButtonPreset: 'preset1', popupButtonBGColor: '#007cba', popupButtonColor: '#fff', popupButtonBorderRadius: 0, popupButtonTopRadius: 0, popupButtonRightRadius: 0, popupButtonBottomRadius: 0, popupButtonLeftRadius: 0, popupButtonTopRadiusTablet: 0, popupButtonRightRadiusTablet: 0, popupButtonBottomRadiusTablet: 0, popupButtonLeftRadiusTablet: 0, popupButtonTopRadiusMobile: 0, popupButtonRightRadiusMobile: 0, popupButtonBottomRadiusMobile: 0, popupButtonLeftRadiusMobile: 0, popupButtonIsRadiusValueUpdated: true })}>{presets.preset1}</button>
                      </div>
                      <div className="responsive-block-editor-addons-popup-button-preset">
                        <button className={popupButtonPreset === 'preset2' ? 'selectedPresetBorder' : 'disabledPresetBorder'} onClick={() => setAttributes({ popupButtonPreset: 'preset2', popupButtonBGColor: '#fff', popupButtonColor: '#007cba', popupButtonBorderRadius: 0, popupButtonTopRadius: 0, popupButtonRightRadius: 0, popupButtonBottomRadius: 0, popupButtonLeftRadius: 0, popupButtonTopRadiusTablet: 0, popupButtonRightRadiusTablet: 0, popupButtonBottomRadiusTablet: 0, popupButtonLeftRadiusTablet: 0, popupButtonTopRadiusMobile: 0, popupButtonRightRadiusMobile: 0, popupButtonBottomRadiusMobile: 0, popupButtonLeftRadiusMobile: 0, popupButtonIsRadiusValueUpdated: true })}>{presets.preset2}</button>
                      </div>
                      <div className="responsive-block-editor-addons-popup-button-preset">
                        <button className={popupButtonPreset === 'preset3' ? 'selectedPresetBorder' : 'disabledPresetBorder'} onClick={() => setAttributes({ popupButtonPreset: 'preset3', popupButtonBGColor: '#007cba', popupButtonColor: '#fff', popupButtonBorderRadius: 4, popupButtonTopRadius: 4, popupButtonRightRadius: 4, popupButtonBottomRadius: 4, popupButtonLeftRadius: 4, popupButtonTopRadiusTablet: 4, popupButtonRightRadiusTablet: 4, popupButtonBottomRadiusTablet: 4, popupButtonLeftRadiusTablet: 4, popupButtonTopRadiusMobile: 4, popupButtonRightRadiusMobile: 4, popupButtonBottomRadiusMobile: 4, popupButtonLeftRadiusMobile: 4, popupButtonIsRadiusValueUpdated: true })}>{presets.preset3}</button>
                      </div>
                      <div className="responsive-block-editor-addons-popup-button-preset">
                        <button className={popupButtonPreset === 'preset4' ? 'selectedPresetBorder' : 'disabledPresetBorder'} onClick={() => setAttributes({ popupButtonPreset: 'preset4', popupButtonBGColor: '#fff', popupButtonColor: '#007cba', popupButtonBorderRadius: 4, popupButtonTopRadius: 4, popupButtonRightRadius: 4, popupButtonBottomRadius: 4, popupButtonLeftRadius: 4, popupButtonTopRadiusTablet: 4, popupButtonRightRadiusTablet: 4, popupButtonBottomRadiusTablet: 4, popupButtonLeftRadiusTablet: 4, popupButtonTopRadiusMobile: 4, popupButtonRightRadiusMobile: 4, popupButtonBottomRadiusMobile: 4, popupButtonLeftRadiusMobile: 4, popupButtonIsRadiusValueUpdated: true })}>{presets.preset4}</button>
                      </div>
                      <div className="responsive-block-editor-addons-popup-button-preset">
                        <button className={popupButtonPreset === 'preset5' ? 'selectedPresetBorder' : 'disabledPresetBorder'} onClick={() => setAttributes({ popupButtonPreset: 'preset5', popupButtonBGColor: '#007cba', popupButtonColor: '#fff', popupButtonBorderRadius: 30, popupButtonTopRadius: 30, popupButtonRightRadius: 30, popupButtonBottomRadius: 30, popupButtonLeftRadius: 30, popupButtonTopRadiusTablet: 30, popupButtonRightRadiusTablet: 30, popupButtonBottomRadiusTablet: 30, popupButtonLeftRadiusTablet: 30, popupButtonTopRadiusMobile: 30, popupButtonRightRadiusMobile: 30, popupButtonBottomRadiusMobile: 30, popupButtonLeftRadiusMobile: 30, popupButtonIsRadiusValueUpdated: true })}>{presets.preset5}</button>
                      </div>
                      <div className="responsive-block-editor-addons-popup-button-preset">
                        <button className={popupButtonPreset === 'preset6' ? 'selectedPresetBorder' : 'disabledPresetBorder'} onClick={() => setAttributes({ popupButtonPreset: 'preset6', popupButtonBGColor: '#fff', popupButtonColor: '#007cba', popupButtonBorderRadius: 30, popupButtonTopRadius: 30, popupButtonRightRadius: 30, popupButtonBottomRadius: 30, popupButtonLeftRadius: 30, popupButtonTopRadiusTablet: 30, popupButtonRightRadiusTablet: 30, popupButtonBottomRadiusTablet: 30, popupButtonLeftRadiusTablet: 30, popupButtonTopRadiusMobile: 30, popupButtonRightRadiusMobile: 30, popupButtonBottomRadiusMobile: 30, popupButtonLeftRadiusMobile: 30, popupButtonIsRadiusValueUpdated: true })}>{presets.preset6}</button>
                      </div>
                    </div>
                  </>
                  }
