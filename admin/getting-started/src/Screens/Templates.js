        ...
        <div className="flex justify-center items-center">
          <div className="w-3/5 px-10 py-[60px] bg-white border border-gray-200 rounded shadow-2xl">
            <div className="flex justify-center">
              <img className="w-10" src={rbealocalize.responsiveurl + 'admin/images/rplus_logo.svg'} alt="Responsive Plus Logo" />
            </div>
            ...
            <p className="mt-4 text-center font-normal text-base text-gray-500">{__( 'Build stunning sites fast with 250+ ready templates. Install the free Responsive Plus plugin to get started.', 'responsive-block-editor-addons' )}</p>
