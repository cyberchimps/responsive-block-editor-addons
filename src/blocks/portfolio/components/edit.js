          ...
          >
            {displayPosts.map((post, i) => (
              ...
              >
                ...
                >
                  <header className="responsive-block-editor-addons-block-portfolio-header">
                    ...
                    {(isPost || isCourse || isLesson) && (
                      <div className="responsive-block-editor-addons-block-portfolio-byline">
                        {attributes.displayPostAuthor &&
                          post.rbea_author_info?.display_name && (
                            <div className="responsive-block-editor-addons-block-portfolio-author">
                              <a
                        ...
                        {attributes.displayPostDate && post.date_gmt && (
                          <time
                            ...
                            className={
                              "responsive-block-editor-addons-block-portfolio-date"
                            }
                          >
                  ...
                  <div className="responsive-block-editor-addons-block-portfolio-excerpt">
                    ...
                    {attributes.displayPostLink && (
                      <p>
                        <a
                          className="responsive-block-editor-addons-block-portfolio-more-link responsive-block-editor-addons-text-link"
                          href={post.link}
                          target="_blank"
                          rel="bookmark"
                        >
