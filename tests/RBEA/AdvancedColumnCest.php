...
class AdvancedColumnCest {
	...
	public function AdvancedColumnsGeneralSettingsTest( RBEATester $I, CommonFunctionsPage $commonFunctionsPageObj ) {
		...
		$defaultGap     = $I->executeInSelenium(
		...
		$containerWidth = $I->executeInSelenium(
			function ( RemoteWebDriver $webdriver ) {
		...
		$heightSelect    = $I->executeInSelenium(
			function ( RemoteWebDriver $webdriver ) {
		...
		$horizontalAlign = $I->executeInSelenium(
			function ( RemoteWebDriver $webdriver ) {
		...
		$verticalAlign   = $I->executeInSelenium(
			function ( RemoteWebDriver $webdriver ) {
	...
	public function AdvancedColumnsBackgroundSettingsTest( RBEATester $I, CommonFunctionsPage $commonFunctionsPageObj ) {
		...
		$sectionBackgroundType = $I->executeInSelenium(
			function ( RemoteWebDriver $webdriver ) {
	...
	public function _changeBackgroundImage( $I, $commonFunctionsPageObj ) {
		$I->click( $this->backgroundSettingBtn );
		$I->wait( 1 );
		$sectionImageBackgroundType = $I->executeInSelenium(
			function ( RemoteWebDriver $webdriver ) {
				return $webdriver->findElement( WebDriverBy::xpath( $this->backgroundTypeSelect ) )->
		...
		$imagePosition = $I->executeInSelenium(
			function ( RemoteWebDriver $webdriver ) {
		...
		$attachment = $I->executeInSelenium(
			function ( RemoteWebDriver $webdriver ) {
		...
		$I->wait( 1 );
		$overlayType = $I->executeInSelenium(
			function ( RemoteWebDriver $webdriver ) {
	...
	public function AdvancedColumnsChildBorderSettingsTest( RBEATester $I, CommonFunctionsPage $commonFunctionsPageObj ) {
		...
		$childContainer = $I->executeInSelenium(
			function ( RemoteWebDriver $webdriver ) {
