		...
		public static function get_responsive_block_table_of_contents_css( $attr, $id ) {
			...
			$selectors = array(
				...
				' .responsive-block-editor-addons-toc__wrap' => array(
					...
					'border-color'  => $attr['blockBorderColor'],
					//Border Radius
					// 'border-top-left-radius' => self::get_css_value( $attr['blockBorderTopLeftRadius'], 'px' ) . ' !important',
					// 'border-top-right-radius' => self::get_css_value( $attr['blockBorderTopRightRadius'], 'px' ) . ' !important',
					// 'border-bottom-left-radius' => self::get_css_value( $attr['blockBorderBottomLeftRadius'], 'px' ) . ' !important',
					// 'border-bottom-right-radius' => self::get_css_value( $attr['blockBorderBottomRightRadius'], 'px' ) . ' !important',
					// Border Width
					// 'border-top-width'    => self::get_css_value( $attr['blockBorderTopWidth'], 'px' ),
					// 'border-left-width'   => self::get_css_value( $attr['blockBorderLeftWidth'], 'px' ),
					// 'border-right-width'  => self::get_css_value( $attr['blockBorderRightWidth'], 'px' ),
					// 'border-bottom-width' => self::get_css_value( $attr['blockBorderBottomWidth'], 'px' ),
					'padding-top'   => self::get_css_value( $attr['blockTopPadding'], 'px' ) . '!important',
					'padding-bottom'=> self::get_css_value( $attr['blockBottomPadding'], 'px' ) . '!important',
					'padding-left'  => self::get_css_value( $attr['blockLeftPadding'], 'px' ) . '!important',
					'padding-right' => self::get_css_value( $attr['blockRightPadding'], 'px' ) . '!important',
			...
			$mobile_selectors = array(
				' .responsive-block-editor-addons-toc__wrap' => array(
					...
					// 'border-top-width'    => self::get_css_value( $attr['blockBorderTopWidthMobile'], 'px' ). '!important',
					// 'border-left-width'   => self::get_css_value( $attr['blockBorderLeftWidthMobile'], 'px' ). '!important',
					// 'border-right-width'  => self::get_css_value( $attr['blockBorderRightWidthMobile'], 'px' ). '!important',
					// 'border-bottom-width' => self::get_css_value( $attr['blockBorderBottomWidthMobile'], 'px' ). '!important',
					// 'border-top-left-radius' => self::get_css_value( $attr['blockBorderTopLeftRadiusMobile'], 'px' ) . ' !important',
					// 'border-top-right-radius' => self::get_css_value( $attr['blockBorderTopRightRadiusMobile'], 'px' ) . ' !important',
					// 'border-bottom-left-radius' => self::get_css_value( $attr['blockBorderBottomLeftRadiusMobile'], 'px' ) . ' !important',
					// 'border-bottom-right-radius' => self::get_css_value( $attr['blockBorderBottomRightRadiusMobile'], 'px' ) . ' !important',
				),
				' .responsive-block-editor-addons-toc__title-wrap' => array(
					'font-size'      => self::get_css_value( $attr['headingFontSizeMobile'], 'px' ),
			...
			$tablet_selectors = array(
				' .responsive-block-editor-addons-toc__wrap' => array(
					...
					// 'border-top-width'    => self::get_css_value( $attr['blockBorderTopWidthTablet'], 'px' ). '!important',
					// 'border-left-width'   => self::get_css_value( $attr['blockBorderLeftWidthTablet'], 'px' ). '!important',
					// 'border-right-width'  => self::get_css_value( $attr['blockBorderRightWidthTablet'], 'px' ). '!important',
					// 'border-bottom-width' => self::get_css_value( $attr['blockBorderBottomWidthTablet'], 'px' ). '!important',
					// 'border-top-left-radius' => self::get_css_value( $attr['blockBorderTopLeftRadiusTablet'], 'px' ) . ' !important',
					// 'border-top-right-radius' => self::get_css_value( $attr['blockBorderTopRightRadiusTablet'], 'px' ) . ' !important',
					// 'border-bottom-left-radius' => self::get_css_value( $attr['blockBorderBottomLeftRadiusTablet'], 'px' ) . ' !important',
					// 'border-bottom-right-radius' => self::get_css_value( $attr['blockBorderBottomRightRadiusTablet'], 'px' ) . ' !important',
				),
				' .responsive-block-editor-addons-toc__title-wrap' => array(
					'font-size'      => self::get_css_value( $attr['headingFontSizeTablet'], 'px' ),
