			...
			>
				...
				if ("mobile" === tab.name) {
					...
					<Fragment>
						...
						value={boxHeightMobile}
						onChange={(value) =>
							setAttributes({
							boxHeightMobile: value,
							})
						}
						min={0}
						max={1000}
						...
						/>
						<RangeControl
						label={__("Margin Mobile", "responsive-block-editor-addons")}
					...
					<Fragment>
						...
						value={boxHeightTablet}
						onChange={(value) =>
							setAttributes({
							boxHeightTablet: value,
							})
						}
						min={0}
						max={1000}
						...
						/>
						<RangeControl
						label={__("Margin Tablet", "responsive-block-editor-addons")}
					...
					<Fragment>
						...
						/>
						<RangeControl
						label={__("Margin", "responsive-block-editor-addons")}
						value={boxMargin}
						onChange={(value) =>
				...
				>
					...
					>
						...
						if ("mobile" === tab.name) {
							...
							<Fragment>
								<RangeControl
								label={__("Padding Top Mobile", "responsive-block-editor-addons")}
								value={boxPaddingTopMobile}
								onChange={(value) => setAttributes({ boxPaddingTopMobile: value })}
								min={0}
								max={100}
								/>
								<RangeControl
								label={__("Padding Right Mobile", "responsive-block-editor-addons")}
								value={boxPaddingRightMobile}
								onChange={(value) => setAttributes({ boxPaddingRightMobile: value })}
								min={0}
								max={100}
								/>
								<RangeControl
								label={__("Padding Bottom Mobile", "responsive-block-editor-addons")}
								value={boxPaddingBottomMobile}
								onChange={(value) => setAttributes({ boxPaddingBottomMobile: value })}
								min={0}
								max={100}
								/>
								<RangeControl
								label={__("Padding Left Mobile", "responsive-block-editor-addons")}
								value={boxPaddingLeftMobile}
								onChange={(value) => setAttributes({ boxPaddingLeftMobile: value })}
								min={0}
								max={100}
								/>
							</Fragment>
							...
							<Fragment>
								<RangeControl
								label={__("Padding Top Tablet", "responsive-block-editor-addons")}
								value={boxPaddingTopTablet}
								onChange={(value) => setAttributes({ boxPaddingTopTablet: value })}
								min={0}
								max={100}
								/>
								<RangeControl
								label={__("Padding Right Tablet", "responsive-block-editor-addons")}
								value={boxPaddingRightTablet}
								onChange={(value) => setAttributes({ boxPaddingRightTablet: value })}
								min={0}
								max={100}
								/>
								<RangeControl
								label={__("Padding Bottom Tablet", "responsive-block-editor-addons")}
								value={boxPaddingBottomTablet}
								onChange={(value) => setAttributes({ boxPaddingBottomTablet: value })}
								min={0}
								max={100}
								/>
								<RangeControl
								label={__("Padding Left Tablet", "responsive-block-editor-addons")}
								value={boxPaddingLeftTablet}
								onChange={(value) => setAttributes({ boxPaddingLeftTablet: value })}
								min={0}
								max={100}
								/>
							</Fragment>
							...
							<Fragment>
								<RangeControl
								label={__("Padding Top", "responsive-block-editor-addons")}
								value={boxPaddingTop}
								onChange={(value) => setAttributes({ boxPaddingTop: value })}
								min={0}
								max={100}
								/>
								<RangeControl
								label={__("Padding Right", "responsive-block-editor-addons")}
								value={boxPaddingRight}
								onChange={(value) => setAttributes({ boxPaddingRight: value })}
								min={0}
								max={100}
								/>
								<RangeControl
								label={__("Padding Bottom", "responsive-block-editor-addons")}
								value={boxPaddingBottom}
								onChange={(value) => setAttributes({ boxPaddingBottom: value })}
								min={0}
								max={100}
								/>
								<RangeControl
								...
								onChange={(value) => setAttributes({ boxPaddingLeft: value })}
								min={0}
								max={100}
								/>
							</Fragment>
			...
			>
				...
				>
					...
					<Fragment>
						...
						onChange={(value) => setAttributes({ containerPaddingTopMobile: value })}
						min={0}
						max={100}
						/>
						<RangeControl
						...
						onChange={(value) => setAttributes({ containerPaddingRightMobile: value })}
						min={0}
						max={100}
						/>
						<RangeControl
						...
						onChange={(value) => setAttributes({ containerPaddingBottomMobile: value })}
						min={0}
						max={100}
						/>
						<RangeControl
						...
						onChange={(value) => setAttributes({ containerPaddingLeftMobile: value })}
						min={0}
						max={100}
						/>
					</Fragment>
					...
					<Fragment>
						...
						onChange={(value) => setAttributes({ containerPaddingTopTablet: value })}
						min={0}
						max={100}
						/>
						<RangeControl
						...
						onChange={(value) => setAttributes({ containerPaddingRightTablet: value })}
						min={0}
						max={100}
						/>
						<RangeControl
						...
						onChange={(value) => setAttributes({ containerPaddingBottomTablet: value })}
						min={0}
						max={100}
						/>
						<RangeControl
						...
						onChange={(value) => setAttributes({ containerPaddingLeftTablet: value })}
						min={0}
						max={100}
						/>
					</Fragment>
