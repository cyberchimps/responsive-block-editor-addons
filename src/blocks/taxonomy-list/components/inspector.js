...
export default class Inspector extends Component {
    ...
    render() {
        ...
        const { attributes, setAttributes, categoriesList, taxonomyList, termsList } = this.props;
        const {
            alignment,
            bgColor,
            gridBorderColor,
        ...
        if ("" != taxonomy_list_setting && undefined != taxonomy_list_setting) {
            var taxonomyListOptions = [
                { value: "", label: __("Select Taxonomy", "responsive-block-editor-addons") }
            ]
        ...
        return (
            <InspectorControls>
                ...
                >
                    ...
                    <SelectControl
                        ...
                        options={[
                            ...
                            { value: "list", label: __("List", "responsive-block-editor-addons") },
                        ]}
                    />
                    {
                        "grid" === layout &&
                    ...
                    {"list" == layout && (
                        <Fragment>
                            <p className="responsive-setting-label">{__("List Style", "responsive-block-editor-addons")}</p>
                            <Button
                                key={"bullet"}
                                icon="editor-ul"
                                label="Bullet"
                    ...
                    <SelectControl
                        ...
                        options={[
                            { value: "post", label: __("Posts", "responsive-block-editor-addons") },
                            { value: "page", label: __("Pages", "responsive-block-editor-addons") },
                        ]}
                    />
                    {"" != taxonomyList &&
                        <SelectControl
                    ...
                    <ToggleControl
                        label={__("Show Empty Taxonomy", "responsive-block-editor-addons")}
                        checked={showEmptyTaxonomy}
                        onChange={(value) => setAttributes({ showEmptyTaxonomy: !showEmptyTaxonomy })}
                        help={__("Show Empty Taxonomy ", "responsive-block-editor-addons")}
                    />
                    <ToggleControl
                        label={__("Show Posts Count", "responsive-block-editor-addons")}
                        checked={showPostCount}
                        onChange={(value) => setAttributes({ showPostCount: !showPostCount })}
                        help={__("Show Count of taxonomy ", "responsive-block-editor-addons")}
                    />
                    {"grid" == layout && (
                        <Fragment>
                            <p className="responsive-setting-label">{__("Alignment", "responsive-block-editor-addons")}</p>
                            <Button
                                key={"left"}
                            ...
                            {showPostCount && (
                                <Fragment>
                                    <ResponsiveSpacingControl
                                        ...
                                        values={{ desktop: titleBottomSpace, tablet: titleBottomSpaceTablet, mobile: titleBottomSpaceMobile }}
                                        setAttributes={setAttributes}
                                        {...this.props}
                                    />
                                </Fragment>
                    ...
                    {"list" === layout && (
                        <Fragment>
                            <ResponsiveSpacingControl
                                ...
                                values={{ desktop: listBottomMargin, tablet: listBottomMarginTablet, mobile: listBottomMarginMobile }}
                                setAttributes={setAttributes}
                                {...this.props}
                            />
                        </Fragment>
                ...
                >
                    {
                        ...
                        <Fragment>
                            ...
                            {showPostCount && (
                                <TypographyHelperControl
                                    title={__("Count Typography", "responsive-block-editor-addons")}
                    ...
                    }
                    {
                        "list" === layout &&
                        <TypographyHelperControl
                            title={__("List Typography", "responsive-block-editor-addons")}
                ...
                <PanelBody
                    title={__("Styling", "responsive-block-editor-addons")}
                    initialOpen={false}
                >
                    {"grid" === layout &&
                        <Fragment>
                            ...
                            <BlockBorderHelperControl
                                ...
                                values={{ radius: gridBorderRadius, style: gridBorderStyle, width: gridBorderWidth, color: gridBorderColor }}
                                setAttributes={setAttributes}
                                {...this.props}
                            />
                        </Fragment>
                    ...
                    {"list" === layout && (
                        <Fragment>
                            <SelectControl
                                label={__("Separator Style", "resposive-block-editor-addons")}
                                value={separatorStyle}
                                onChange={(value) => setAttributes({ separatorStyle: value })}
                                options={[
                                    { value: "none", label: __("None", "resposive-block-editor-addons") },
                                    { value: "solid", label: __("Solid", "resposive-block-editor-addons") },
                                    { value: "dotted", label: __("Dotted", "resposive-block-editor-addons") },
                                    { value: "dashed", label: __("Dashed", "resposive-block-editor-addons") },
                                    { value: "double", label: __("Double", "resposive-block-editor-addons") },
                                    { value: "groove", label: __("Groove", "resposive-block-editor-addons") },
                                    { value: "inset", label: __("Inset", "resposive-block-editor-addons") },
                                    { value: "outset", label: __("Outset", "resposive-block-editor-addons") },
                                    { value: "ridge", label: __("Ridge", "resposive-block-editor-addons") },
                                ]}
                            />
                            {"none" !== separatorStyle && (
                                <Fragment>
