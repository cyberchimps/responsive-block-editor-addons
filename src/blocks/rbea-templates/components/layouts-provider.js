/**
 * Fetches Patterns and Layouts for the Pattern Importer
 *
 * Fetches different patterns in tabs
...
export default class LayoutsProvider extends Component {
	...
	addFavorite( key ) {
		return apiFetch( {
			path: '/rbeablocks/v1/layouts/favorites',
			method: 'PATCH',
			body: JSON.stringify( { rbea_blocks_favorite_key: key } ),
	...
	async componentDidMount() {
		...
		wp.apiFetch( {
			method: 'GET',
			path: '/rbeablocks/v1/layouts/all?filter=allowed',
