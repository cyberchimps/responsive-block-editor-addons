...
if ( ! class_exists( 'Responsive_Block_Editor_Addons_Frontend_Styles' ) ) {
    ...
    ';
		...
		public static function get_responsive_block_card_css( $attr, $id ) {
			...
			$mobile_selectors = array(
				'' => array(
					'display' => true === $attr['hideWidgetMoblie'] ? 'none' : 'block',
		...
		public static function get_responsive_block_inline_notice_css( $attr, $id ) {
			...
			$selectors = array(
				' ' => array(
					'display' => true === $attr['hideWidget'] ? 'none' : 'inline-block',
			...
			$mobile_selectors = array(
				' ' => array(
					'display' => true === $attr['hideWidgetMobile'] ? 'none' : 'inlie-block',
			...
			$tablet_selectors = array(
				' ' => array(
					'display' => true === $attr['hideWidgetTablet'] ? 'none' : 'inline-block',
