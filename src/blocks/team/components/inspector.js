  ...
  render() {
    ...
    return (
      <InspectorControls key="inspector">
        ...
        >
          ...
          >
            ...
            {bgGradient && (
              <Fragment>
                <PanelColorSettings
                  title={__("Primary Color", "responsive-block-editor-addons")}
                  initialOpen={false}
                  colorSettings={[
                    {
                      value: backgroundColor,
        ...
        >
          <RangeControl
            label={__("Title Bottom Spacing", "responsive-block-editor-addons")}
            value={titleSpacing}
            onChange={(value) =>
              this.props.setAttributes({
                titleSpacing: value,
          ...
          />
          <RangeControl
            label={__("Image Margin Bottom", "responsive-block-editor-addons")}
        ...
        >
          <PanelBody
            title={__("Hide Social Icons", "responsive-block-editor-addons")}
            initialOpen={true}
          >
            <ToggleControl
              label="Twitter"
