...
function EditorStyles(props) {
  ...
  var selectors = {
    ...
    " .responsive-block-editor-addons-block-portfolio-image img": {
      "border-radius": generateCSSUnit(imageBorderRadius, "px"),
      "object-fit": "cover",
      "height": "100%",
        "margin-bottom": generateCSSUnit(imageBottomSpacing, "px"),
    },
    " .responsive-block-editor-addons-block-portfolio-text": {
    ...
    " .responsive-block-editor-addons-block-portfolio-title a:hover": {
      color: titleHoverColor,
    },
    " .responsive-block-editor-addons-block-portfolio-author a": {
      color: metaColor,
    },
    " .responsive-block-editor-addons-block-portfolio-byline": {
      color: metaColor,
    ...
    " .responsive-block-editor-addons-block-portfolio-excerpt": {
      color: textColor,
    ...
    " .responsive-block-editor-addons-block-portfolio-excerpt > div > p": {
      "margin-bottom": generateCSSUnit(excerptBottomSpacing, "px"),
    },
    " .responsive-block-editor-addons-block-portfolio-more-link.responsive-block-editor-addons-text-link": {
    ...
    " .responsive-block-editor-addons-block-portfolio-more-link:hover": {
