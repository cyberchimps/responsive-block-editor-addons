 ...
 */
import DeprecatedTestimonial from "./deprecateTestimonial";
...
export default class DeprecatedTestimonialSave extends Component {
  constructor() {
    super(...arguments);
  }
    ...
    return (
      ...
      >
        {testimonialBlock?.map((test, index) => (
          <DeprecatedTestimonial key={`testimonial-${index}`} {...this.props}>
            <RichText.Content
              tagName="div"
