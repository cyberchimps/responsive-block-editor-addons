...
export default function ResponsiveContentPaddingControlHelper (props) {
            ...
            <div className="rbea-size-type-field-tabs">
                <div className="rbea-control__header">
                    <div className="uag-responsive-label-wrap">
                        <span className="uag-control-label">{__('Content Padding', 'responsive-block-editor-addons')}</span>
                    </div>
