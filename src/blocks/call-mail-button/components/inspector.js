...
export default class Inspector extends Component {
  ...
  onChangeMail(mail) {
	const validMailRegex = RegExp(/^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$/)
			...
			>
				...
				/>
				{
					"call" === buttonToShow && ( 
						<Fragment>
							...
							{
								!isValidNumber && (
									<p style={{color:'red'}}>Please make sure your input is a valid phone number.</p>
								)
							}
						</Fragment>
					)
				}
				{
					"mail" === buttonToShow && (
						<Fragment>
							<TextControl
								label={__("Enter your mail address", "responsive-block-editor-addons")}
								type="text"
								value={mail}
								onChange={ (value) => {
			...
			>
				...
				/>
				{
					"flexible" === buttonWidthType && (
						...
						<Fragment>
						<RangeControl
							label={__("Button Width Mobile", "responsive-block-editor-addons")}
							value={buttonWidthMobile}
							onChange={(value) => setAttributes({ buttonWidthMobile: value })}
							min={0}
							max={1000}
						/>
						</Fragment>
						...
						<Fragment>
						<RangeControl
							label={__("Button Width Tablet", "responsive-block-editor-addons")}
							value={buttonWidthTablet}
							onChange={(value) => setAttributes({ buttonWidthTablet: value })}
							min={0}
							max={1000}
						/>
						</Fragment>
						...
						<Fragment>
						<RangeControl
							label={__("Button Width", "responsive-block-editor-addons")}
							value={buttonWidth}
          ...
          <InspectorTab key={'style'}>
			...
			>
				<ToggleControl
					...
					onChange={(value) => setAttributes({buttonRounded: !buttonRounded})}
				/>
				{
					true === buttonRounded && (
						<RangeControl
				...
				<ToggleControl
					...
					onChange={(value) => setAttributes({buttonTransparent: !buttonTransparent})}
				/>
			</PanelBody>
			<PanelBody
			...
			>
				...
				<TabPanel
					...
					<Fragment>
					<RangeControl
						label={__("Gap between icon and text", "responsive-block-editor-addons")}
						value={iconTextGapMobile}
						onChange={(value) => setAttributes({ iconTextGapMobile: value })}
						min={0}
						max={1000}
					/>
					</Fragment>
					...
					<RangeControl
						...
						onChange={(value) => setAttributes({ iconTextGapTablet: value })}
						min={0}
						max={1000}
					/>
					</Fragment>
					...
					<RangeControl
						label={__("Gap between icon and text", "responsive-block-editor-addons")}
						value={iconTextGap}
						onChange={(value) => setAttributes({ iconTextGap: value })}
						min={0}
						max={1000}
					/>
					</Fragment>
					...
					!buttonTransparent && (
						<Fragment>
							...
							<ColorPalette
								...
								onChange={(value) => setAttributes({ buttonTextColorHover: value })}
								allowReset
							/>
						</Fragment>
					)
