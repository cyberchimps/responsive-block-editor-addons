...
class Responsive_Block_Editor_Addons_Frontend_Styles_Helper_Test extends WP_UnitTestCase {
	...
	/**
	 * Test for get_block_css for testimonial_slider for background image
	 */
	public function test_get_block_css_testimonial_slider_background_image() {
		$attributes  = self::$rbea_frontend_styles->get_responsive_block_testimonial_slider_block_default_attributes();
		$block       = array(
			'blockName'    => 'responsive-block-editor-addons/testimonial-slider',
			'attrs'        => array_merge(
				$attributes,
				array(
					'block_id'                 => self::$testimonial_slider_block_id,
					'backgroundImage'          => 'someURL',
	...
	/**
	 * Test for get_block_css for testimonial_slider for background image radial
	 */
	public function test_get_block_css_testimonial_slider_background_image_radial() {
		$attributes  = self::$rbea_frontend_styles->get_responsive_block_testimonial_slider_block_default_attributes();
		$block       = array(
			'blockName'    => 'responsive-block-editor-addons/testimonial-slider',
			'attrs'        => array_merge(
