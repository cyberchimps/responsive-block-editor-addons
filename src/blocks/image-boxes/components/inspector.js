      ...
      <InspectorControls key="inspector">
        <InspectorTabs>
          ...
          <InspectorTab key={'style'}>
            ...
            <PanelBody
              title={__("Font Colors", "responsive-block-editor-addons")}
              initialOpen={false}
            >
              <p className="responsive-block-editor-addons-setting-label">
                {__("Title Text Color", "responsive-block-editor-addons")}
              ...
              />
              <p className="responsive-block-editor-addons-setting-label">
                {__("Description Text Color", "responsive-block-editor-addons")}
                <span className="components-base-control__label">
                  <span
                    className="component-color-indicator"
